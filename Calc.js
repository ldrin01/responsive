...
function operator(value1){
	...
	document.getElementById('last').innerHTML = firstnum;
	document.getElementById('last').innerHTML = firstnum.toFixed(1);
}
function show(){
	if(arithmetic != '0'){
	if(repeat == '0'){
		...
		document.getElementById('last').innerHTML = secondnum;
		temporary = answer;
	...
	if(repeat == '1'){
		...
		document.getElementById('last').innerHTML = temporary;
		temporary = answer;
	}
	limit = '0';
	repeat = '1'
...
function fordecimal(a){
	...
	if(size < 14){
		...
		document.getElementById('result').innerHTML= another;
	}else if(size >= 14){
		another = answer.toExponential(10);
		document.getElementById('result').innerHTML= another;
	}
	document.getElementById('last').innerHTML = another;
}
function del(){
	if(arithmetic == 0){
		fake = firstnum;
